    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-6">
            ...
            <div>
                ...
                <a href="{{ route('admin.admm.clients.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                ...
                <a href="{{ route('admin.admm.sim-cards.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                ...
                <a href="{{ route('admin.admm.gps-devices.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                ...
                <a href="{{ route('admin.admm.accessories.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                ...
                <a href="{{ route('admin.admm.sim-import.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
            ...
            <div>
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
        ...
        <div class="border-t border-gray-700 p-4 flex-shrink-0">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-400 truncate">{{ auth()->user()->role ?? 'BT Staff' }}</p>
                </div>
