...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-6">
            ...
            {{-- AFIS --}}
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 mb-1">Fleet Management</p>
                ...
                @php [$active, $cls] = $navLink('', 'Online / Offline States', '', 'admin.afis.intelligence.*'); @endphp
            ...
            <div>
                ...
                @php [$active, $cls] = $navLink('', 'Audit Log', '', 'admin.admm.audit-log'); @endphp
                <a href="{{ route('admin.admm.audit-log') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors {{ $cls }}">                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                    Audit Log
                </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" title="Sign out" class="text-red-600 hover:text-white transition-colors">
                        <svg class="w-8 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
                    </button>
                </form>
            </div>
        </div>
