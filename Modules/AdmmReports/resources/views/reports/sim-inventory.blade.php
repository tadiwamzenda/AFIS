...
@section('title', 'SIM Card Inventory')
@section('page-title', 'SIM Card Inventory')

@section('header-actions')
    <a href="{{ route('admin.admm.reports.sim-inventory', ['format' => 'excel']) }}"
    ...
    <a href="{{ route('admin.admm.reports.sim-inventory', ['format' => 'pdf']) }}"
