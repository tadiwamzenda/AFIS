...
@section('title', 'SIM Cards by Provider')
@section('page-title', 'SIM Cards by Provider')

@section('header-actions')
    <a href="{{ route('admin.admm.reports.sim-by-provider', ['format' => 'excel']) }}"
    ...
    <a href="{{ route('admin.admm.reports.sim-by-provider', ['format' => 'pdf']) }}"
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    <div class="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
        <p class="text-sm text-gray-500">{{ $groups->count() }} providers</p>
    ...
    <div class="overflow-x-auto">
        ...
        <div class="border-b border-gray-200 last:border-b-0">
            <div class="px-4 py-3 bg-gray-50 flex items-center justify-between">
                <h3 class="font-medium text-gray-700">{{ $provider }}</h3>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                    <tr><td colspan="7" class="px-4 py-4 text-center text-gray-400">No SIM cards for this provider.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
