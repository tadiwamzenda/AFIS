...
@section('title', 'Accessories by Type')
@section('page-title', 'Accessories by Type')

@section('header-actions')
    <a href="{{ route('admin.admm.reports.accessories-by-type', ['format' => 'excel']) }}"
    ...
    <a href="{{ route('admin.admm.reports.accessories-by-type', ['format' => 'pdf']) }}"
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    <div class="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
        <p class="text-sm text-gray-500">{{ $groups->count() }} types</p>
    ...
    <div class="overflow-x-auto">
        ...
        <div class="border-b border-gray-200 last:border-b-0">
            <div class="px-4 py-3 bg-gray-50 flex items-center justify-between">
                <h3 class="font-medium text-gray-700">{{ $type ?: 'Uncategorized' }}</h3>
                <span class="text-xs text-gray-500">{{ $rows->count() }} accessories</span>
            </div>
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50/50">
                        ...
                        <th class="text-left px-4 py-2 font-medium text-gray-600">Device</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                    <tr><td colspan="5" class="px-4 py-4 text-center text-gray-400">No accessories of this type.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
