...
@section('title', 'Devices in Stock')
@section('page-title', 'Devices in Stock')

@section('header-actions')
    <a href="{{ route('admin.admm.reports.devices-in-stock', ['format' => 'excel']) }}"
    ...
    <a href="{{ route('admin.admm.reports.devices-in-stock', ['format' => 'pdf']) }}"
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                @empty
                <tr><td colspan="8" class="px-4 py-8 text-center text-gray-400">No devices in stock.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
