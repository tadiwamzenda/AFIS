...
<body>
    <h1>Bantu Track — Device Inventory</h1>
    <p class="meta">Generated {{ now()->format('d M Y H:i') }} · {{ $rows->count() }} records</p>

    <table>
        <thead>
            <tr><th>Serial Number</th><th>Model</th><th>Firmware</th><th>Status</th><th>Location</th><th>Client</th><th>Vehicle</th><th>SIM Card</th></tr>
        </thead>
        <tbody>
