    ...
    <form wire:submit="save" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    Navixy security group ID
                    <span class="text-gray-400 font-normal text-xs">(from subuser/list)</span>
                </label>
                <input wire:model="navixy_security_group_id" type="number"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                    placeholder="e.g. 26353">
                <p class="mt-1 text-xs text-gray-400">Links this client to their Navixy sub-users. Find it in the Postman subuser/list response.</p>
            </div>
            {{-- Contact Person --}}
            <div>
