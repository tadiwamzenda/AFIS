...
@section('header-actions')
    <a href="{{ route('admin.admm.gps-devices.index') }}"
        class="text-sm font-medium text-gray-600 hover:text-gray-800 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
        List GPS Devices
    </a>
    <a href="{{ route('admin.admm.gps-import.index') }}"
